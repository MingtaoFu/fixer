    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li><a href="page?property=5&page=1">库存管理</a></li>
          <li><a href="page?property=5&page=2">出库清单</a></li>
          <li class="active"><a href="#">出库请求<span class="sr-only">(current)</span></a></li>
        </ul>
...
<!--     <div id="toolbar">
    ...
    <table id="table" data-toolbar="#toolbar" data-search="true"
           ...
           data-url="parts_request" data-response-handler="responseHandler">
    </table>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">确认出库请求</h4>
            </div>
...
<!--                         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
 -->                            <div class="control-group">
                                    <label class="control-label" for="partName">备件名称</label>
                                    <div class="controls">
                                  <!--   <input type="text" placeholder="备件名称" class="form-control"
                                           id="partName" name="partName"> -->
                                            <select class="selectpicker form-control selectpicker-ajax" data-live-search="true"
                                                    id="partName" name="partName"></select>
                                    </div>
                                </div>
                            <div class="control-group">
                                <label class="control-label" for="price">出库单价</label>
                                <div class="controls">
                                    <input type="tel" placeholder="出库单价" class="form-control"
                                           id="price" name="price">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="quantity">出库数量</label>
                                <div class="controls">
...
<script type="text/javascript" src="./static/js/parts_request.js"></script>
</body>
</html>
