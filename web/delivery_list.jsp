    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="#">出库清单<span class="sr-only">(current)</span></a></li>
...
<div class="container">
    ...
    <table id="table" data-toolbar="#toolbar" data-search="true"
           ...
           data-url="delivery_list" data-response-handler="responseHandler">
    </table>
</div>
<!-- Modal -->
                    ...
                    <!--<fieldset class="row">-->
                        <!--<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">-->
                            <!--<div class="control-group">-->
                                <!--<label class="control-label" for="partName">请求人</label>-->
                                <!--<div class="controls">-->
...
<script type="text/javascript" src="./static/js/delivery_list.js"></script>
</body>
</html>
